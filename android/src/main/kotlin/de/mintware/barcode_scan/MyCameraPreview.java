...
public class MyCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MyCameraPreview(Context context, CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public MyCameraPreview(Context context, AttributeSet attrs, CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(cameraWrapper, previewCallback);
    }
    ...
    private void adjustViewSize(Camera.Size cameraSize) {
        ...
        if (screenRatio > cameraRatio) {
            ...
            setViewSize((int) (previewSize.x), (int) (previewSize.x / cameraRatio));
        }
    }
