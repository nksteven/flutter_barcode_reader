...
public abstract class MyBarcodeScannerView  extends BarcodeScannerView {
    private static final String TAG = "MyBarcodeScannerView";
    ...
    protected IViewFinder createViewFinderView(Context context) {
        MyViewFinderView viewFinderView = new MyViewFinderView(context);
    ...
    public  void setupMyLayout(CameraWrapper cameraWrapper) {
        removeAllViews();
        mPreview = new MyCameraPreview(getContext(), cameraWrapper, this);
