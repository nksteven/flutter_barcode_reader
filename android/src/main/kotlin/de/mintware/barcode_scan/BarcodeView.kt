...
class BarcodeView : PlatformView, ZXingScannerView.ResultHandler, MethodChannel.MethodCallHandler {
    ...
    private fun setupScannerView() {
        ...
        scannerView = ZXingAutofocusScannerView(mContext).apply {
            setAutoFocus(true)
    ...
    override fun getView(): View {
        return scannerView as ZXingAutofocusScannerView;
    }
}